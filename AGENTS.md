...
- Keep package names, namespaces, Composer metadata, publish tags, documentation, and examples aligned with `onelegstudios/shape`.
...
- Workbench stylesheets: `composer assets`
- Workbench server: `composer serve` (runs `assets` and `build` first)
